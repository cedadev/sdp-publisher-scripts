...
log("requested to publish {0} using mapfile {1}".format(dataset_id, mapfile_path))
...
# For speed, do not do THREDDS reinit during unpublishing because it is not necessary
# and can wait until after publication to THREDDS (see unpub_args above).  However,
# ensure that if the publication to db or creation of the THREDDS XML file fail, 
# the THREDDS reinit still gets done.
